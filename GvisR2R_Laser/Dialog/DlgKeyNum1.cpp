// DlgKeyNum1.cpp : implementation file
//
...
void CDlgKeyNum1::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgKeyNum1)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDlgKeyNum1, CDialog)
	//{{AFX_MSG_MAP(CDlgKeyNum1)
...
/////////////////////////////////////////////////////////////////////////////
// CDlgKeyNum1 message handlers

void CDlgKeyNum1::OnButtonBs() 
{
...
void CDlgKeyNum1::OnButtonEnter() 
{
	// TODO: Add your control notification handler code here
...
void CDlgKeyNum1::OnButtonMinus() 
{
	// TODO: Add your control notification handler code here
...
void CDlgKeyNum1::OnButtonRight() 
{
	// TODO: Add your control notification handler code here
	GetDlgItem(IDC_EDIT_DISPLAY)->SetFocus();
	SendDlgItemMessage(IDC_EDIT_DISPLAY,WM_KEYDOWN,VK_RIGHT,0);
...
HBRUSH CDlgKeyNum1::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
...
void CDlgKeyNum1::DispVal()
{
	if(m_strM.IsEmpty())
		GetDlgItem(IDC_STC_MSG)->ShowWindow(SW_HIDE);
	else
...
void CDlgKeyNum1::InitStatic()
{
	myStatic.SubclassDlgItem(IDC_STC_MSG, this);
	myStatic.SetTextColor(RGB_BLUE);
	myStatic.SetBkColor(RGB_GREEN);
	myStatic.SetFontSize(14);
	myStatic.SetFontName(_T("Arial"));
	myStatic.SetFontBold(TRUE);
}

void CDlgKeyNum1::InitEdit()
{
...
void CDlgKeyNum1::InitPic()
{
	myPic.Load(IMG_KEYPAD_BK);
}

void CDlgKeyNum1::InitBtn()
{
	//Bitmap Button Init....
...
BOOL CDlgKeyNum1::SetCtrlColor(const UINT nID, CString strText, COLORREF bgColor, COLORREF fgColor)
{
	RECT rect;
	CWnd* wndCtrl = NULL;
    CString str=_T("");
...
BOOL CDlgKeyNum1::PreTranslateMessage(MSG* pMsg) 
{
...
void CDlgKeyNum1::KillFocus(int nID)
{
...
void CDlgKeyNum1::SetPasswordStyle() 
{
	((CEdit*)GetDlgItem(IDC_EDIT_DISPLAY))->SetPasswordChar('*');
}

void CDlgKeyNum1::OnMove(int x, int y) 
{
	CDialog::OnMove(x, y);
...
void CDlgKeyNum1::OnLButtonDown(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
	m_dnMouse = TRUE;
	m_stPoint = point;
...
void CDlgKeyNum1::OnMouseMove(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
	if(m_dnMouse)
	{
...
void CDlgKeyNum1::OnLButtonUp(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
	m_dnMouse = FALSE;
...
LRESULT CDlgKeyNum1::OnMyKeyPadNum(WPARAM wPara, LPARAM lPara)
{
	if(!m_bTIM_DLG_KEYBDNUM)
		return 0L;
