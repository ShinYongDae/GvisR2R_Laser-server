#if !defined(AFX_DLGMYKEYPAD_H__77A1B6BD_5CD3_473D_BE7C_88EF37B14329__INCLUDED_)
#define AFX_DLGMYKEYPAD_H__77A1B6BD_5CD3_473D_BE7C_88EF37B14329__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DlgMyKeypad.h : header file
//
#include "MyPic.h"
#include "MyBtn.h"
#include "MyGroup.h"
...
class CDlgMyKeypad : public CDialog
{
	BOOL m_bFont;
	CFont m_Font;
	BOOL m_bLoadImg;
...
// Construction
public:
	CDlgMyKeypad(CString *strFileName, CRect* rect=NULL, CPoint ptSt=(0, 0), int nDir=TO_NONE, CWnd* pParent=NULL);   // standard constructor
	~CDlgMyKeypad();
...
// Dialog Data
	//{{AFX_DATA(CDlgMyKeypad)
	enum { IDD = IDD_DLG_MY_KEYPAD };
...
#endif // !defined(AFX_DLGMYKEYPAD_H__77A1B6BD_5CD3_473D_BE7C_88EF37B14329__INCLUDED_)
