...
typedef enum _stSigInx {
	...
	_JoinSelRe, _MvCwRe, _MvCcwRe, _PrdChuckRe, _DancerUpRe, _PasteUpLfRe, _PasteUpRtRe, _PasteVacRe, _PprChuckRe,
	_PprWheelCwRe, PprWheelCcwRe, _DoRe, _PrdPprRe,
	_JoinSelMk, _MvCwMk, _MvCcwMk, _FdVacMk, _PprPushMk, _TblBlwMk, _TblVacMk, _FdClampMk, _TensClampMk, _OnePnlMk, _LsrMk, _DancerUpMk,
	_JoinSelAoiDn, _MvCwAoiDn, _MvCcwAoiDn, _FdVacAoiDn, _PprPushAoiDn, _TblBlwAoiDn, _TblVacAoiDn, _FdClampAoiDn, _TensClampAoiDn, 
	_OnePnlAoiDn, _LsrAoiDn,
	_JoinSelAoiUp, _MvCwAoiUp, _MvCcwAoiUp, _FdVacAoiUp, _PprPushAoiUp, _TblBlwAoiUp, _TblVacAoiUp, _FdClampAoiUp, _TensClampAoiUp,
	_OnePnlAoiUp, _LsrAoiUp,
	_JoinSelEng, _MvCwEng, _MvCcwEng, _FdVacEng, _PprPushEng, _TblBlwEng, _TblVacEng, _FdClampEng, _TensClampEng, _OnePnlEng, _LsrEng, _DancerUpEng,
	_JoinSelUn, _MvCwUn, _MvCcwUn, _PrdChuckUn, _DancerUpUn, _PasteUpLfUn, _PasteUpRtUn, _PasteVacUn, _PprChuckUn,
	_PprWheelCwUn, PprWheelCcwUn, _ClrRollUpUn, _ClrRollPushUn,
